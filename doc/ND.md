...
Use `work_queue` etc from the CC lab:
    ...
    export PYTHONPATH=$PYTHONPATH:/afs/crc.nd.edu/group/ccl/software/cctools-018-5f8a45b8-cvmfs-40cf5bba/x86_64/redhat6/lib/python2.6/site-packages
    export PATH=/afs/crc.nd.edu/group/ccl/software/cctools-018-5f8a45b8-cvmfs-40cf5bba/x86_64/redhat6/bin:$PATH

or, for `tcsh` users,

    setenv PYTHONPATH ${PYTHONPATH}:/afs/crc.nd.edu/group/ccl/software/cctools-018-5f8a45b8-cvmfs-40cf5bba/x86_64/redhat6/lib/python2.6/site-packages
    setenv PATH /afs/crc.nd.edu/group/ccl/software/cctools-018-5f8a45b8-cvmfs-40cf5bba/x86_64/redhat6/bin:${PATH}
