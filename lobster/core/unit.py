...
TaskUpdate = util.record('TaskUpdate',
                         ...
                         'time_epilogue_end',
                         'time_stage_out_end',
                         'time_stage_in_end_new',
                         'time_prologue_end_new',
                         'time_processing_end_new',
                         'time_epilogue_end_new',
                         'time_stage_out_end_new',
...
class UnitStore:
    ...
    def __init__(self, config):
        ...
        self.db.execute("""create table if not exists tasks(
            ...
            time_stage_in_end_new float default 0 not null,
            time_prologue_end_new float default 0 not null,
            time_processing_end_new float default 0 not null,
            time_epilogue_end_new float default 0 not null,
            time_stage_out_end_new float default 0 not null,
