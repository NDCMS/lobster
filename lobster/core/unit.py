...
class UnitStore:
    def __init__(self, config):
        ...
        self.db.execute("""create table if not exists tasks(
            ...
            network_bandwidth int default 0,
            network_bytes_received int default 0,
            network_bytes_sent int default 0,
            cache int default 0,
            cache_end_size int default 0,
            cache_start_size int default 0,
            workflow int,
            id integer primary key autoincrement,
            ...
            memory_resident int default 0,
            memory_virtual int default 0,
            memory_swap int default 0,
            published_file_block text,
            status int default 0,
            submissions int default 0,
            time_submit int default 0,
            time_transfer_in_start int default 0,
            time_transfer_in_end int default 0,
            time_wrapper_start int default 0,
            time_wrapper_ready int default 0,
            time_stage_in_end int default 0,
            time_prologue_end int default 0,
            time_file_requested int default 0,
            time_file_opened int default 0,
            time_file_processing int default 0,
            time_processing_end int default 0,
            time_epilogue_end int default 0,
            time_stage_out_end int default 0,
            time_transfer_out_start int default 0,
            time_transfer_out_end int default 0,
            time_retrieved int default 0,
            time_on_worker int default 0,
            time_total_on_worker int default 0,
            time_cpu int default 0,
            type int default 0,
            workdir_footprint int default 0,
            workdir_num_files int default 0,
